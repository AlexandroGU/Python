...
# Windows [Version 10.0.18363.1316]
...
print('first_version - выделено памяти: {0}.'.format(mem_1))
print('second_version - выделено памяти: {0}.'.format(mem_2))
print('third_version - выделено памяти: {0}.'.format(mem_3))
...
# Вывод: Лучший вариант - 3, т.к. он занимает меньше всего памяти.